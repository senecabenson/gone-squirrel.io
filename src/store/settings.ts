...
interface SettingsStore extends Settings {
  ...
  // Design-system toggles (GoneSquirrel redesign)
  motionEnabled: boolean;
  iconLabelsHidden: boolean;
  themeMode: "light" | "dark" | "system";
  colorMode: "full" | "reduced";
  contrast: "normal" | "high";
  timeOfDayShift: boolean;
  ...
  setIconLabelsHidden: (value: boolean) => void;
  setThemeMode: (mode: "light" | "dark" | "system") => void;
  setColorMode: (mode: "full" | "reduced") => void;
  setContrast: (value: "normal" | "high") => void;
  setTimeOfDayShift: (value: boolean) => void;
...
const defaultSettings: Settings & {
  ...
  accounts: [],
  motionEnabled: true,
  iconLabelsHidden: false,
  themeMode: "system",
  colorMode: "full",
  contrast: "normal",
  timeOfDayShift: false,
...
export const useSettingsStore = create<SettingsStore>()(
  persist(
    (set, get) => ({
      ...
      setIconLabelsHidden: (value) => set({ iconLabelsHidden: value }),
      setThemeMode: (mode) => set({ themeMode: mode }),
      setColorMode: (mode) => set({ colorMode: mode }),
      setContrast: (value) => set({ contrast: value }),
      setTimeOfDayShift: (value) => set({ timeOfDayShift: value }),
