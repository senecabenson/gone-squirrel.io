...
export function getPasswordResetTemplate(
  ...
  return `
    <h1>Reset Your GoneSquirrel Password</h1>
    <p>Hi ${name},</p>
    <p>We received a request to reset your password for your GoneSquirrel account. If you didn&apos;t make this request, you can safely ignore this email.</p>
