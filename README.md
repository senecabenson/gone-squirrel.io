...
> Personal-use fork. Originally based on [FluidCalendar](https://github.com/dotnetfactory/fluid-calendar) by @dotnetfactory.

An open-source alternative to Motion, designed for intelligent task scheduling and calendar management. GoneSquirrel helps you stay on top of your tasks with smart scheduling capabilities, calendar integration, and customizable workflows.
